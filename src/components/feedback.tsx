                    ...
                    <div>
                        <div className='grid grid-cols-2 mb-5'>
                            <ul className='inline-flex items-center'>
                                <li className='text-[32px] leading-[38px] font-medium Urbanist text-white'>01</li>
                                <li className='text-xl leading-6 font-medium Urbanist text-white/60'> /04</li>
                            </ul>
                        ...
                        <div className='grid grid-cols-2 justify-between'>
                            ...
                            <ul className='inline-flex items-center justify-end gap-1'>
                                <li>
                                    <BsChevronLeft size={16} className="w-11 h-11 p-3 border border-white/60  text-white/60 rounded-[31px] cursor-pointer" />
                                </li>
                                <li>
                                    <BsChevronRight size={16} className="w-11 h-11 p-3 border border-white  text-white rounded-[31px] cursor-pointer" />
                                </li>
                            </ul>
                        </div>
                    </div>
