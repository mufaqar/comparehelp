...
function AboutUs() {
    return (
        <section className='py-20 bg-[url(/svg/half-circle.svg)] bg-no-repeat bg-right' style={{ backgroundSize: "15%", backgroundPositionY: "-70%" }}>
            <div className='container mx-auto px-4 relative z-10'>
                ...
                <div className='relative'>
                    ...
                    <div className='grid md:grid-cols-2 grid-cols-1 gap-12'>
                        <div className='w-full h-full bg-gradient-to-b from-[#E3DDEC] gap-12 p-12 grid rounded-[24px] border border-white/20'>
                            <div>
